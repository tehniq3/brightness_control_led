 ...
 * ver.1.b - minimum/maximum limit indicator
 */
...
void setup() {
  ...
  pinMode(ledminmax,OUTPUT);//
  digitalWrite(ledminmax, LOW);  // led minim / maxim stins
}
...
int aflareduratapasare1() 
 ...
 if(apasarebuton1 == LOW && stare1 == true) 
   ...
   if (durata1 > duratamare1) 
      ...
      {
        nivel = nivelmin;
        digitalWrite(ledminmax, HIGH);  // led minim / maxim aprins
      }
      delay(micropauza);
      lung1 = 1;
      }  
