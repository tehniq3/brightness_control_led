 ...
 * version for ATtiny85 by Gheorghe Vlad - https://vlad-gheorghe.blogspot.com/
 */

#define buton1 PB1  // buton 1 fara retine la masa
#define buton2 PB2  // buton 2 fara retine la masa
#define led PB4    // led + rezistenta 220..470 ohmi la masa
